  ...
  "sections": [
      ...
      "projects": [
        {
          ...
          "description": "Inspired by GitHub's error page, I drew this mountain scene and   added a 3d effect by transforming layers according to their distance   from the screen as well as the position of the mouse cursor. This   runs at 60Hz on all modern browsers – unlike Github's version! ",
        ...
        {
          "title": "MetroJS",
          "description": "I designed an animated tube map, with cars using complex    route-planning and stopping at individual stations. ",
      ...
      "projects": [
        {
          ...
          "description": "To keep better track of my finances, I built a serverless budget tracker using Python on AWS Lambda functions, called when I spend money or request information about my spending. Data is stored in a DynamoDB table and optionally written to a Google Sheets document.",
        ...
        {
          "title": "PySh",
          "description": "This tool uses Python's dynamic nature to expose every command-line   tool on the user's machine as a function on an importable Python   module. Input, output and errors are all handled sanely. ",
      ...
      "projects": [
        {
          ...
          "description": "As part of my budget tracker, I built a web dashboard in Elm with a   burndown chart and a table with my top 5 spending categories.",
        ...
        {
          "title": "Echo Chamber",
          "description": "Elm's inbuilt support for WebSockets make it a perfect candidate for   building highly performant webapps which can update in realtime.   This simple chat app demonstrates how easy it is to use websockets   in Elm. ",
          "url": "https://github.com/bedekelly/elm-chat",
    ...
    },
    {
      ...
      "projects": [
        {
          "title": "Hashtables",
          "description": "I wrote a hashtable entirely in C, implementing table doubling to   keep reads/writes at O(1). The code is performant and idiomatic C99. ",
